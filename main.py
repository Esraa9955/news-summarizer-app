...
class AssistnatManager:
  thread_id="thread_0lfb2Ta6eAm4rdCcn3LLOXGD"
  assistant_id= "asst_Kg57SAZzot41f8kHKLl7Z79L"
  ...
  def __init__(self,model: str=model):
    ...
    if AssistnatManager.assistant_id:
      self.assistant = self.client.beta.assistants.retrieve(
        assistant_id=AssistnatManager.assistant_id
      )
    if AssistnatManager.thread_id:
      self.thread = self.client.beta.threads.retrieve(
        thread_id=AssistnatManager.thread_id
      )
  ...
  def create_assistant(self,name,instructions,tools):
    if not self.assistant:
      ...
      AssistnatManager.assistant_id=assistant_obj.id
  ...
  def create_thread(self):
    if not self.thread:
      ...
      AssistnatManager.thread_id= thread_obj.id
            ...
            "function":{
              ...
              "parameters":{
                ...
                "properties":{
                  "topic":{
                    "type": "string",
                    "description":"The topic for news, e.g. bitcoin",
                  }
                },
              "required":["topic"],
              },
